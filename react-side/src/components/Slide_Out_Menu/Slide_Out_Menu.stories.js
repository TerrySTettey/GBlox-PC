...
function Slide_Out_Menu_Component() {
    const device_svg = <svg xmlns="http://www.w3.org/2000/svg" width="227.914" height="175.467" viewBox="0 0 227.914 175.467">
    <defs>
