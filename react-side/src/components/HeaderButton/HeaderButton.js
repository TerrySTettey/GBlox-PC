...
const HeaderButton = (props) => {
    ...
    switch (props.buttonImage) {
        case "1":
            ...
            break;
        case "2":
            buttonImage = <svg id="Component_3_2" data-name="Component 3 – 2" xmlns="http://www.w3.org/2000/svg" width="120" height="40" viewBox="0 0 120 40">
                <path id="Path_33" data-name="Path 33" d="M306.954,42h94.091c5.06,5.1,7.9,7.961,12.955,13.063V82H294V55.063Z" transform="translate(-294 -42)" fill={buttonColor} />
                <g id="Group_31" data-name="Group 31" transform="translate(30.99 8.794)">
        ...
        case "3":
            ...
            break;
        case "4":
            buttonImage = <svg id="Component_3_6" data-name="Component 3 – 6" xmlns="http://www.w3.org/2000/svg" width="180" height="40" viewBox="0 0 180 40">
                <path id="Path_33" data-name="Path 33" d="M306.954,42H461.045c5.06,5.1,7.9,7.961,12.955,13.063V82H294V55.063Z" transform="translate(-294 -42)" fill={buttonColor} />
                <g id="Group_31" data-name="Group 31" transform="translate(17.401 9)">
                    <text id="RoboCentre" transform="translate(31.826 18)" fill="#fff" font-size="17" font-family="Baloo2-Regular, 'Baloo \32"><tspan x="0" y="0">RoboCentre</tspan></text>
                    <g id="Group_432" data-name="Group 432" transform="translate(-176.12 -91.374)">
                        <g id="Group_432-2" data-name="Group 432" transform="translate(177.062 91.374)">
        ...
        case "6":
            buttonImage = <svg id="Component_3_3" data-name="Component 3 – 3" xmlns="http://www.w3.org/2000/svg" width="130" height="40" viewBox="0 0 130 40">
                <path id="Path_33" data-name="Path 33" d="M306.954,42H411.045c5.06,5.1,7.9,7.961,12.955,13.063V82H294V55.063Z" transform="translate(-294 -42)" fill={buttonColor} />
                <g id="Group_31" data-name="Group 31" transform="translate(30.99 8.794)">
