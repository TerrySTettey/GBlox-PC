...
const Button = (props) => {
    ...
    switch (props.type) {
        ...
        case "DeviceAddButton":
            buttonType = (
                <div>
                    <div className="c-button-a-DeviceAddButton" style={{
                        fill: `${svgColor}`
                    }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25">
                            <g id="Add_Button" data-name="Add Button" transform="translate(-166 -240)">
                                <circle id="Ellipse_4" data-name="Ellipse 4" cx="12.5" cy="12.5" r="12.5" transform="translate(166 240)" fill={props.svgColor} />
